                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="hero-content">
                                ...
                                <div class="hero-btn wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
                                    <a href="index.html#" class="theme-btn">Get 7 Days Trail</a>
                                    <a href="index.html#" class="theme-btn theme-btn2">Learn More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item">
                            ...
                            <h3 class="service-title">
                                <a href="index.html#">Free Service</a>
                            </h3>
                            <p class="service-text">There are many variations of passages available but the majority have suffered.</p>
                            <div class="service-arrow">
                                <a href="index.html#" class="service-read-btn">Learn More<i class="far fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item active">
                            ...
                            <h3 class="service-title">
                                <a href="index.html#">Premium Service</a>
                            </h3>
                            <p class="service-text">There are many variations of passages available but the majority have suffered.</p>
                            <div class="service-arrow">
                                <a href="index.html#" class="service-read-btn">Learn More<i class="far fa-long-arrow-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item">
                            ...
                            <h3 class="service-title">
                                <a href="index.html#">Gigabit Service</a>
                            </h3>
                            <p class="service-text">There are many variations of passages available but the majority have suffered.</p>
                            <div class="service-arrow">
                                <a href="index.html#" class="service-read-btn">Learn More<i class="far fa-long-arrow-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item">
                            ...
                            <h3 class="service-title">
                                <a href="index.html#">VPN For Business</a>
                            </h3>
                            <p class="service-text">There are many variations of passages available but the majority have suffered.</p>
                            <div class="service-arrow">
                                <a href="index.html#" class="service-read-btn">Learn More<i class="far fa-long-arrow-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item">
                            ...
                            <h3 class="service-title">
                                <a href="index.html#">Stream Service</a>
                            </h3>
                            <p class="service-text">There are many variations of passages available but the majority have suffered.</p>
                            <div class="service-arrow">
                                <a href="index.html#" class="service-read-btn">Learn More<i class="far fa-long-arrow-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item">
                            ...
                            <h3 class="service-title">
                                <a href="index.html#">VPN For Teams</a>
                            </h3>
                            <p class="service-text">There are many variations of passages available but the majority have suffered.</p>
                            <div class="service-arrow">
                                <a href="index.html#" class="service-read-btn">Learn More<i class="far fa-long-arrow-right"></i></a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="g-location-map">
                            <img src="assets/img/location/map.svg" alt="map-image" />
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="video-wrapper">
                            <img src="assets/img/video/video.png" alt="Banner Video" />
            ...
            <div class="container">
                <div class="row">
                    <div class="cta-content">
                        ...
                        <a href="index.html#" class="theme-btn mt-5">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="download-content">
                            ...
                            <div class="download-now">
                                <h5>Available On:</h5>
                                <a href="index.html#" class="apple-store"><i class="fab fa-apple"></i></a>
                                <a href="index.html#" class="google-play"><i class="fab fa-google-play"></i></a>
                                <a href="index.html#" class="windows"><i class="fab fa-windows"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="index.html#">Malissa Fierro</a></h5>
                                    <span>Developer</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="index.html#">Arron Rodri</a></h5>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="team-item active">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="index.html#">Chad Smith</a></h5>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="team-item">
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h5><a href="index.html#">Tony Pinto</a></h5>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-item-info">
                                <div class="blog-item-meta">
                                    <ul>
                                        <li>
                                            <a href="index.html#"><i class="far fa-user-circle"></i> By Alicia Davis</a>
                                        </li>
                                        <li>
                                            <a href="index.html#"><i class="far fa-calendar-alt"></i> May 10, 2023</a>
                                        </li>
                                    </ul>
                                </div>
                                <h4 class="blog-title">
                                    <a href="index.html#">There are many variates of passages alteration</a>
                                </h4>
