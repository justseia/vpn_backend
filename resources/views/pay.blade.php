...
@section('content')
    <main class="main">
        <div class="site-breadcrumb">
            <div class="container">
                <h2 class="breadcrumb-title">Pay</h2>
        ...
        <div class="container" style="display: flex">
            ...
            <div class="form-container">
                ...
                <div class="field-container">
                    ...
                    <svg id="ccicon" class="ccicon" width="750" height="471" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg"></svg>
                </div>
                <div class="field-container">
                ...
                <div class="field-container">
                    <label for="secsuritycode">Security Code</label>
                    <input id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric">
                </div>
            </div>
        </div>
        <div class="header-nav-right" style="display: flex; justify-content: center;">
            <div class="header-btn">
                <a href="{{ route('profile.index') }}" class="theme-btn">Buy</a>
            </div>
        </div>
    </main>
